...
import ProofOfResidenceThirdFileComponent from '../../../files-components/proof-of-residence-third-file-component';


const ProofOfResidenceThirdForm = () => {
    ...
    const [cpfThird, setCpfThird] = useState("");
    const [identityThird, setIdentityThird] = useState("");
    const [identityEntityThird, setIdentityEntityThird] = useState("");
    const [stateIdentityThird, setStateIdentityThird] = useState("");

    const data = {
        nameThird: nameThird,
        cpfThird: cpfThird,
        identityThird: identityThird,
        identityEntityThird: identityEntityThird,
        stateIdentityThird: stateIdentityThird,
        name: name,
        cpf: cpf,
        identity: identity,
    ...
    const clearDocument = () => {
        ...
        setCpfThird("");
        setIdentityThird("");
        setIdentityEntityThird("");
        setStateIdentityThird("");
        setShow(false);
        setName("");
        setCpf("");
        setIdentity("");
            ...
            <Row>
                    <Form.Group>
                        ...
                        <Form.Control
                            type="text"
                            value={nameThird}
                            onChange={(item) => setNameThird(item.target.value)}
                        />
                    </Form.Group>
                </Row>
                <Row>
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Control
                                ...
                                maxLength={11}
                                value={cpfThird}
                                onChange={(item) => setCpfThird(item.target.value)}
                            />
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Control
                                type="text"
                                value={identityThird}
                                onChange={(item) => setIdentityThird(item.target.value)}
                            />
                        </Form.Group>
                    </Col>
                    <Col sm={2} md={2} lg={2}>
                        <Form.Group>
                            ...
                            <Form.Control
                                type="text"
                                value={identityEntityThird}
                                onChange={(item) => setIdentityEntityThird(item.target.value)}
                            />
                        </Form.Group>
                    </Col>
                    <Col sm={2} md={2} lg={2}>
                        <Form.Group>
                            ...
                            <Form.Control
                                type="text"
                                value={stateIdentityThird}
                                onChange={(item) => setStateIdentityThird(item.target.value)}
                            />
                        </Form.Group>
                    </Col>
                </Row>
            ...
            {show ? (
                <div>
                    <PDFViewer className="w-100">
                        <ProofOfResidenceThirdFileComponent data={data} />
                    </PDFViewer>
                </div>
            ) : (
                <WaitingPdfComponent />
...
export default ProofOfResidenceThirdForm;